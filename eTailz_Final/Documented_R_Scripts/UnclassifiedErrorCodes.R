...
UnclassifiedErrorCodes<-PipelineFinalVendors[PipelineFinalVendors$ErrorCodeClass=="" & !PipelineFinalVendors$Messages=="" & !is.na(PipelineFinalVendors$Messages),
                                             colnames(PipelineFinalVendors) %in% c("SKU", "Messages", "fileName", "ErrorCodeClass")]
